...
var theatres,count,num,ctx,chart,body=$("body"),movietickets=$(".movie-tickets"),mainHeader=$("header");$(document).ready(function(){$.getJSON("json/movies.json").done(function(e){for(var t in $.each(e,function(e,t){var a=new Date(0);a.setUTCSeconds(t.data_date),day=moment(a).format("MMMM Do YYYY"),movietickets.append("<div class='grid ticket-row'><div class='ticket-col'><h2>"+t.title+"</h2><span class='theatres' data-theatre='"+t.theatre+"'>"+t.theatre+"</span></div><div class='ticket-col'><h4 class='date' data-date='"+t.data_date+"'>"+day+"</h4></div></div>")}),$(".movie-tickets .ticket-row").sort(function(e,t){return new Date($(".date",t).data("date"))-new Date($(".date",e).data("date"))}).appendTo(".movie-tickets"),num=$(".ticket-row").length,$("#numOfMovies").html(" "+num),theatres=[],$("span.theatres").each(function(){theatres[$(this).attr("data-theatre")]=!0}),count=[],theatres)count.push(t);$("#numOfTheatres").html(" "+count.length)}).fail(function(e,t,a){var n=t+", "+a;console.log("Request Failed: "+n)}),mainHeader.headroom({offset:0,tolerance:0,classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.hasClass("open")&&mainHeader.removeClass("unpinned")},onTop:function(){mainHeader.removeClass("pinned")}}),ctx=document.getElementById("chart").getContext("2d"),chart=new Chart(ctx,{type:"line",data:{labels:["2007","2008","2009","2010","2011","2012","2013","2014","2015","2016","2017","2018"],datasets:[{data:[4,7,25,20,5,17,21,16,14,7,22,13],borderColor:"rgba(238, 238, 238, 1)",pointRadius:5,pointBackgroundColor:"rgba(239, 201, 84, 1)",pointBorderColor:"rgba(255, 255, 255, 0)"}]},options:{scales:{yAxes:[{ticks:{beginAtZero:!0}}]},legend:{display:!1}}})});