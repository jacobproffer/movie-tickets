...
var theatres,count,num,ctx,chart,body=$("body"),movietickets=$(".movies__tickets"),mainHeader=$("header");$(document).ready(function(){$.getJSON("json/movies.json").done(function(e){var t,a,o,n,s=(t=e,a={},$.each(t,function(){a[this.year]=1+(a[this.year]||0)}),a),i=(o=s,n=[],Object.keys(o).forEach(function(e){n.push({year:e,count:o[e]})}),n);$.each(e,function(e,t){var a=new Date(0);a.setUTCSeconds(t.data_date),day=moment(a).format("MMMM Do YYYY"),movietickets.append("<div class='movies__ticket__col'><div class='movies__ticket__content'><h2>"+t.title+"</h2><h4 class='movies__date' data-date='"+t.data_date+"'>"+day+"</h4><span class='movies__theatres' data-theatre='"+t.theatre+"'>"+t.theatre+"</span></div></div>")});var d=[],r=[];for(var c in $.each(i,function(e,t){d.push(t.year),r.push(t.count)}),ctx=document.getElementById("chart").getContext("2d"),Chart.defaults.global.defaultFontColor="#d0d0d0",(chart=new Chart(ctx,{type:"line",data:{labels:d,datasets:[{data:r,borderColor:"#d0d0d0",pointRadius:4,pointBackgroundColor:"#7f7f7f",pointBorderColor:"rgba(255, 255, 255, 0)",backgroundColor:"rgba(255, 255, 255, .0)"}]},maintainAspectRatio:!1,options:{scales:{xAxes:[{gridLines:{color:"rgba(127, 127, 127, .35)"}}],yAxes:[{gridLines:{color:"rgba(127, 127, 127, .35)"},ticks:{beginAtZero:!0}}]},legend:{display:!1},layout:{padding:{top:10,left:-5,right:-5}}}})).aspectRatio=0,$(".movies__tickets .movies__ticket__col").sort(function(e,t){return new Date($(".movies__date",t).data("date"))-new Date($(".movies__date",e).data("date"))}).appendTo(".movies__tickets"),num=$(".movies__ticket__col").length,$("#number-of-movies").html(num+" movies"),theatres=[],$("span.movies__theatres").each(function(){theatres[$(this).attr("data-theatre")]=!0}),r=[],theatres)r.push(c);$("#number-of-theatres").html(r.length+" theaters")}).fail(function(e,t,a){var o=t+", "+a;console.log("Request Failed: "+o)}),mainHeader.headroom({offset:0,tolerance:0,classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.hasClass("open")&&mainHeader.removeClass("unpinned")},onTop:function(){mainHeader.removeClass("pinned")}})});