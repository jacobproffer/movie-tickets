...
var theatres,count,num,ctx,chart,body=$("body"),movietickets=$(".movies__tickets"),mainHeader=$("header");$(document).ready(function(){$.getJSON("json/movies.json").done(function(e){var t,i,a,n,o=(t=e,i={},$.each(t,function(){i[this.year]=1+(i[this.year]||0)}),i),l=(a=o,n=[],Object.keys(a).forEach(function(e){n.push({year:e,count:a[e]})}),n);$.each(e,function(e,t){var i=new Date(0);i.setUTCSeconds(t.data_date),day=moment(i).format("MMMM Do YYYY"),movietickets.append("<div class='movies__ticket__col'><div class='movies__ticket__content'><h2>"+t.title+"</h2><span class='movies__theatres' data-theatre='"+t.theatre+"'>"+t.theatre+"</span><h4 class='movies__date' data-date='"+t.data_date+"'>"+day+"</h4></div><ul class='cut left-cut'><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li></ul><ul class='cut right-cut'><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li><li></li></ul></div>")});var s=[],d=[];for(var c in $.each(l,function(e,t){s.push(t.year),d.push(t.count)}),ctx=document.getElementById("chart").getContext("2d"),chart=new Chart(ctx,{type:"line",data:{labels:s,datasets:[{data:d,borderColor:"#8475db",pointRadius:4,pointBackgroundColor:"#fff",pointBorderColor:"rgba(255, 255, 255, 0)"}]},options:{scales:{yAxes:[{ticks:{beginAtZero:!0}}]},legend:{display:!1},layout:{padding:{top:10}}}}),$(".movies__tickets .movies__ticket__col").sort(function(e,t){return new Date($(".movies__date",t).data("date"))-new Date($(".movies__date",e).data("date"))}).appendTo(".movies__tickets"),num=$(".movies__ticket__row").length,$("#number-of-movies").html(" "+num),theatres=[],$("span.movies__theatres").each(function(){theatres[$(this).attr("data-theatre")]=!0}),d=[],theatres)d.push(c);$("#number-of-theatres").html(" "+d.length)}).fail(function(e,t,i){var a=t+", "+i;console.log("Request Failed: "+a)}),mainHeader.headroom({offset:0,tolerance:0,classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.hasClass("open")&&mainHeader.removeClass("unpinned")},onTop:function(){mainHeader.removeClass("pinned")}})});