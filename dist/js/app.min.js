...
var theatres,count,num,ctx,chart,body=$("body"),movietickets=$(".movie-tickets"),mainHeader=$("header");$(document).ready(function(){$(".open-info-modal").click(function(){$(".info-modal").removeClass("close-info-modal"),body.addClass("stop-scroll"),body.addClass("disable-scrolling")}),$(".info-modal-close").click(function(){$(".info-modal").addClass("close-info-modal"),body.removeClass("stop-scroll"),body.removeClass("disable-scrolling")}),document.ontouchmove=function(e){for(var t=!0,a=e.target;null!==a;){if(a.classList&&a.classList.contains("disable-scrolling")){t=!1;break}a=a.parentNode}t||e.preventDefault()},$.getJSON("json/movies.json").done(function(e){for(var t in $.each(e,function(e,t){var a=new Date(0);a.setUTCSeconds(t.data_date),day=moment(a).format("MMMM Do YYYY"),movietickets.append("<div class='ticket-row'><div class='ticket-col'><h2>"+t.title+"</h2><span class='theatres' data-theatre='"+t.theatre+"'>"+t.theatre+"</span></div><div class='ticket-col'><h4 class='date' data-date='"+t.data_date+"'>"+day+"</h4></div></div>")}),$(".movie-tickets .ticket-row").sort(function(e,t){return new Date($(".date",t).data("date"))-new Date($(".date",e).data("date"))}).appendTo(".movie-tickets"),num=$(".ticket-row").length,$("#numOfMovies").html(" "+num),theatres=[],$("span.theatres").each(function(){theatres[$(this).attr("data-theatre")]=!0}),count=[],theatres)count.push(t);$("#numOfTheatres").html(" "+count.length)}).fail(function(e,t,a){var o=t+", "+a;console.log("Request Failed: "+o)}),mainHeader.headroom({offset:0,tolerance:0,classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.hasClass("open")&&mainHeader.removeClass("unpinned")},onTop:function(){mainHeader.removeClass("pinned")}}),ctx=document.getElementById("chart").getContext("2d"),chart=new Chart(ctx,{type:"bar",data:{labels:["Red","Blue","Yellow","Green","Purple","Orange"],datasets:[{label:"# of Votes",data:[3,4,4,5,2,5],backgroundColor:"rgba(238, 238, 238, 1)",hoverBackgroundColor:"rgba(134, 172, 122, 1)"}]},options:{scales:{yAxes:[{ticks:{beginAtZero:!0}}]}}})});