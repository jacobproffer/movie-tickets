...
var theatres,count,num,body=$("body"),movietickets=$(".movie-tickets"),mainHeader=$("header");$(document).ready(function(){$(".open-info-modal").click(function(){$(".info-modal").removeClass("close-info-modal"),body.addClass("stop-scroll"),body.addClass("disable-scrolling")}),$(".info-modal-close").click(function(){$(".info-modal").addClass("close-info-modal"),body.removeClass("stop-scroll"),body.removeClass("disable-scrolling")}),document.ontouchmove=function(e){for(var t=!0,o=e.target;null!==o;){if(o.classList&&o.classList.contains("disable-scrolling")){t=!1;break}o=o.parentNode}t||e.preventDefault()},$.getJSON("json/movies.json").done(function(e){$.each(e,function(e,t){movietickets.append("<div class='ticket-row'><div class='ticket-col'><h2>"+t.title+"</h2><span class='theatres' data-theatre='"+t.theatre+"'>"+t.theatre+"</span></div><div class='ticket-col'><h4 class='date' data-date='"+t.date+"'>"+t.date+"</h4></div></div>")}),$(".movie-tickets .ticket-row").sort(function(e,t){return new Date($(".date",t).data("date"))-new Date($(".date",e).data("date"))}).appendTo(".movie-tickets"),num=$(".ticket-row").length,$("#numOfMovies").html(" "+num),theatres=[],$("span.theatres").each(function(){theatres[$(this).attr("data-theatre")]=!0}),count=[];for(var t in theatres)count.push(t);$("#numOfTheatres").html(" "+count.length)}).fail(function(e,t,o){var a=t+", "+o;console.log("Request Failed: "+a)}),mainHeader.headroom({offset:0,tolerance:0,classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.hasClass("open")&&mainHeader.removeClass("unpinned")},onTop:function(){mainHeader.removeClass("pinned")}})});