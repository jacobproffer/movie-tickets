...
var theatres,count,num,ctx,chart,body=$("body"),movietickets=$(".movie-tickets"),mainHeader=$("header");$(document).ready(function(){$.getJSON("json/movies.json").done(function(e){var t,a,n,o,s=(t=e,a={},$.each(t,function(){a[this.year]=1+(a[this.year]||0)}),a),i=(n=s,o=[],Object.keys(n).forEach(function(e){o.push({year:e,count:n[e]})}),o);console.log(i),$.each(e,function(e,t){var a=new Date(0);a.setUTCSeconds(t.data_date),day=moment(a).format("MMMM Do YYYY"),movietickets.append("<div class='grid ticket-row'><div class='ticket-col'><h2>"+t.title+"</h2><span class='theatres' data-theatre='"+t.theatre+"'>"+t.theatre+"</span></div><div class='ticket-col'><h4 class='date' data-date='"+t.data_date+"'>"+day+"</h4></div></div>")});var d=[],r=[];for(var c in $.each(i,function(e,t){d.push(t.year),r.push(t.count)}),console.log(d),ctx=document.getElementById("chart").getContext("2d"),chart=new Chart(ctx,{type:"line",data:{labels:d,datasets:[{data:r,borderColor:"rgba(238, 238, 238, 1)",pointRadius:4,pointBackgroundColor:"rgba(239, 201, 84, 1)",pointBorderColor:"rgba(255, 255, 255, 0)"}]},options:{scales:{yAxes:[{ticks:{beginAtZero:!0}}]},legend:{display:!1},layout:{padding:{top:10}}}}),$(".movie-tickets .ticket-row").sort(function(e,t){return new Date($(".date",t).data("date"))-new Date($(".date",e).data("date"))}).appendTo(".movie-tickets"),num=$(".ticket-row").length,$("#numOfMovies").html(" "+num),theatres=[],$("span.theatres").each(function(){theatres[$(this).attr("data-theatre")]=!0}),r=[],theatres)r.push(c);$("#numOfTheatres").html(" "+r.length)}).fail(function(e,t,a){var n=t+", "+a;console.log("Request Failed: "+n)}),mainHeader.headroom({offset:0,tolerance:0,classes:{pinned:"pinned",unpinned:"unpinned",top:"onTop",bottom:"onBottom",notTop:"scrolled"},onUnpin:function(){mainHeader.hasClass("open")&&mainHeader.removeClass("unpinned")},onTop:function(){mainHeader.removeClass("pinned")}})});